...
public class Mocking {
    ...
    public static void mockReferee() {
        refereeDAO.clearAll();
        refereeDAO.create(new RefereeEntity("Sandro Meira Ricci", "Brasil", 15, "Representou o Brasil nas Copas de 2014 e 2018."));
        refereeDAO.create(new RefereeEntity("Anderson Daronco", "Brasil", 12, "Conhecido pelo porte físico, apita na Libertadores e Brasileirão."));
        refereeDAO.create(new RefereeEntity("Raphael Claus", "Brasil", 14, "Eleito melhor árbitro do Brasileirão diversas vezes, atuou na Copa do Mundo de 2022."));
        refereeDAO.create(new RefereeEntity("Wilton Pereira Sampaio", "Brasil", 16, "Árbitro FIFA, apitou as quartas de final da Copa do Mundo de 2022."));
        refereeDAO.create(new RefereeEntity("Carlos Eugênio Simon", "Brasil", 20, "Apitou nas Copas do Mundo de 2002, 2006 e 2010. Hoje é comentarista."));
        refereeDAO.create(new RefereeEntity("Nestor Pitana", "Argentina", 15, "Apitou a final da Copa do Mundo de 2018 entre França e Croácia."));
        refereeDAO.create(new RefereeEntity("Wilmar Roldán", "Colômbia", 18, "Um dos árbitros com mais partidas na história da Copa Libertadores."));
        refereeDAO.create(new RefereeEntity("Andrés Cunha", "Uruguai", 13, "Árbitro na Copa de 2018 e na polêmica final da Libertadores de 2018."));
