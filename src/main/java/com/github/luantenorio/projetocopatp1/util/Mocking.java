...
public class Mocking {
    ...
    public static void mockTeam(){
        teamDAO.clearAll();
        teamDAO.create(new TeamEntity("6c473ace-a4a6-4500-93a3-71ae440b6224", "Brasil", "Dorival Júnior", "Brasil"));
        teamDAO.create(new TeamEntity("a64d611a-128b-4a5a-b043-c727724d78ba", "Argentina", "Lionel Scaloni", "Argentina"));
        teamDAO.create(new TeamEntity("dc7f4336-5d5b-4d8e-a34f-049a580d3d5f", "França", "Didier Deschamps", "França"));
        teamDAO.create(new TeamEntity("ccdb54ee-2416-4377-8add-00e85a6e50d6", "Inglaterra", "Gareth Southgate", "Inglaterra"));
        teamDAO.create(new TeamEntity("735b7ab3-37ab-4aa1-a586-ab679a533d27", "Espanha", "Luis de la Fuente", "Espanha"));
        teamDAO.create(new TeamEntity("e49a6614-99b3-4c26-9c87-14b27f879920", "Alemanha", "Julian Nagelsmann", "Alemanha"));
        teamDAO.create(new TeamEntity("Portugal", "Roberto Martínez", "Portugal"));
        teamDAO.create(new TeamEntity("Itália", "Luciano Spalletti", "Itália"));
        teamDAO.create(new TeamEntity("Holanda", "Ronald Koeman", "Holanda"));
        teamDAO.create(new TeamEntity("Uruguai", "Marcelo Bielsa", "Uruguai"));
        teamDAO.create(new TeamEntity("Croácia", "Zlatko Dalic", "Croácia"));
        teamDAO.create(new TeamEntity("Bélgica", "Domenico Tedesco", "Bélgica"));
        teamDAO.create(new TeamEntity("Colômbia", "Néstor Lorenzo", "Colômbia"));
        teamDAO.create(new TeamEntity("México", "Jaime Lozano", "México"));
        teamDAO.create(new TeamEntity("Estados Unidos", "Gregg Berhalter", "Estados Unidos"));
        teamDAO.create(new TeamEntity("Suíça", "Murat Yakin", "Suíça"));
        teamDAO.create(new TeamEntity("Senegal", "Aliou Cissé", "Senegal"));
        teamDAO.create(new TeamEntity("Marrocos", "Walid Regragui", "Marrocos"));
        teamDAO.create(new TeamEntity("Japão", "Hajime Moriyasu", "Japão"));
        teamDAO.create(new TeamEntity("Coreia do Sul", "Hong Myung-bo", "Coreia do Sul"));
        teamDAO.create(new TeamEntity("Nigéria", "José Peseiro", "Nigéria"));
        teamDAO.create(new TeamEntity("Argélia", "Vladimir Petkovic", "Argélia"));
        teamDAO.create(new TeamEntity("Egito", "Rui Vitória", "Egito"));
        teamDAO.create(new TeamEntity("Gana", "Otto Addo", "Gana"));
        teamDAO.create(new TeamEntity("Costa do Marfim", "Emerse Faé", "Costa do Marfim"));
        teamDAO.create(new TeamEntity("Camarões", "Marc Brys", "Camarões"));
        teamDAO.create(new TeamEntity("Chile", "Ricardo Gareca", "Chile"));
        teamDAO.create(new TeamEntity("Equador", "Félix Sánchez", "Equador"));
        teamDAO.create(new TeamEntity("Peru", "Jorge Fossati", "Peru"));
        teamDAO.create(new TeamEntity("Paraguai", "Daniel Garnero", "Paraguai"));
