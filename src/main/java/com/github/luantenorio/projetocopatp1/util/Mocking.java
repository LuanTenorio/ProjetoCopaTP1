...
public class Mocking {
    ...
    public static void mockTeam(){
        teamDAO.clearAll();
        teamDAO.create(new TeamEntity("6c473ace-a4a6-4500-93a3-71ae440b6224", "Brasil", "A", "Dorival Júnior", "Brasil"));
        teamDAO.create(new TeamEntity("a64d611a-128b-4a5a-b043-c727724d78ba", "Argentina", "A", "Lionel Scaloni", "Argentina"));
        teamDAO.create(new TeamEntity("dc7f4336-5d5b-4d8e-a34f-049a580d3d5f", "França", "A", "Didier Deschamps", "França"));
        teamDAO.create(new TeamEntity("ccdb54ee-2416-4377-8add-00e85a6e50d6", "Inglaterra", "A", "Gareth Southgate", "Inglaterra"));
        teamDAO.create(new TeamEntity("735b7ab3-37ab-4aa1-a586-ab679a533d27", "Espanha", "B", "Luis de la Fuente", "Espanha"));
        teamDAO.create(new TeamEntity("e49a6614-99b3-4c26-9c87-14b27f879920", "Alemanha", "B", "Julian Nagelsmann", "Alemanha"));
        teamDAO.create(new TeamEntity("Portugal", "B", "Roberto Martínez", "Portugal"));
        teamDAO.create(new TeamEntity("Itália", "B", "Luciano Spalletti", "Itália"));
        teamDAO.create(new TeamEntity("Holanda", "C", "Ronald Koeman", "Holanda"));
        teamDAO.create(new TeamEntity("Uruguai", "C", "Marcelo Bielsa", "Uruguai"));
        teamDAO.create(new TeamEntity("Croácia", "C", "Zlatko Dalic", "Croácia"));
        teamDAO.create(new TeamEntity("Bélgica", "C", "Domenico Tedesco", "Bélgica"));
        teamDAO.create(new TeamEntity("Colômbia", "D", "Néstor Lorenzo", "Colômbia"));
        teamDAO.create(new TeamEntity("México", "D", "Jaime Lozano", "México"));
        teamDAO.create(new TeamEntity("Estados Unidos", "D", "Gregg Berhalter", "Estados Unidos"));
        teamDAO.create(new TeamEntity("Suíça", "D", "Murat Yakin", "Suíça"));
        teamDAO.create(new TeamEntity("Senegal", "E", "Aliou Cissé", "Senegal"));
        teamDAO.create(new TeamEntity("Marrocos", "E", "Walid Regragui", "Marrocos"));
        teamDAO.create(new TeamEntity("Japão", "E", "Hajime Moriyasu", "Japão"));
        teamDAO.create(new TeamEntity("Coreia do Sul", "E", "Hong Myung-bo", "Coreia do Sul"));
        teamDAO.create(new TeamEntity("Nigéria", "F", "José Peseiro", "Nigéria"));
        teamDAO.create(new TeamEntity("Argélia", "F", "Vladimir Petkovic", "Argélia"));
        teamDAO.create(new TeamEntity("Egito", "F", "Rui Vitória", "Egito"));
        teamDAO.create(new TeamEntity("Gana", "F", "Otto Addo", "Gana"));
        teamDAO.create(new TeamEntity("Costa do Marfim", "G", "Emerse Faé", "Costa do Marfim"));
        teamDAO.create(new TeamEntity("Camarões", "G", "Marc Brys", "Camarões"));
        teamDAO.create(new TeamEntity("Chile", "G", "Ricardo Gareca", "Chile"));
        teamDAO.create(new TeamEntity("Equador", "G", "Félix Sánchez", "Equador"));
        teamDAO.create(new TeamEntity("Peru", "H", "Jorge Fossati", "Peru"));
        teamDAO.create(new TeamEntity("Paraguai", "H", "Daniel Garnero", "Paraguai"));
        System.out.println("Mock dos times...");
    }
